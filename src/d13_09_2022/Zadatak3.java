...
//		Morate da dohvatite uvek Add dugme iz poslednjeg reda tabele. Mozete koristeci 
//		index iz petlje, a mozete koristeci i last() fukncionalnost za xpath. Koristan link last mehnizma
//		Cekanje od 0.5s
//		Na kraju programa ugasite pretrazivac.
		...
		for (int i = 0; i < 5; i++) {
			...
			driver.findElement(By.name("name")).sendKeys("Nemanja Stojanovic");
			driver.findElement(By.name("department")).sendKeys("IT");
			driver.findElement(By.name("phone")).sendKeys("069100100");
			driver.findElement(By.xpath("//tr[last()]//*[@class = 'add']//i[@class = 'material-icons']")).click();
			Thread.sleep(500);
